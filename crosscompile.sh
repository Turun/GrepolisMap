...
zip "TurunMap-V$TURUNMAP_VERSION-x86_64-pc-windows-gnu.zip" "target/x86_64-pc-windows-gnu/release/turunmap"
zip "TurunMap-V$TURUNMAP_VERSION-x86_64-pc-windows-msvc.zip" "target/x86_64-pc-windows-msvc/release/turunmap"
