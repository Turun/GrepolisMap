        ...
        egui::popup_below_widget(ui, popup_id, &r, |ui| {
            ...
            for var in it {
                ...
                if mat[0].0 == 0 {
                    ...
                    let mut cursor = mat[0].0 + mat[0].1.len(); // TODO: is len() the right choice? maybe we need chars or something
                    ...
                    let mut job = LayoutJob::default();
                    let mut cursor = 0; // TODO: is len() the right choice? maybe we need chars or something
